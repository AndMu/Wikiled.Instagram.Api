...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Business
{
    public class InstaStatisticsAccountInsightsUnitResponse
    {
        ...
        [JsonProperty("last_week_call")] public int? LastWeekCall { get; set; } = 0;

        [JsonProperty("last_week_email")] public int? LastWeekEmail { get; set; } = 0;
        ...
        [JsonProperty("last_week_reach")] public int? LastWeekReach { get; set; } = 0;

        [JsonProperty("last_week_text")] public int? LastWeekText { get; set; } = 0;

        [JsonProperty("last_week_website_visits")]
        public int? LastWeekWebsiteVisits { get; set; } = 0;

        [JsonProperty("week_over_week_call")] public int? WeekOverWeekCall { get; set; } = 0;

        [JsonProperty("week_over_week_email")] public int? WeekOverWeekEmail { get; set; } = 0;
        ...
        [JsonProperty("week_over_week_reach")] public int? WeekOverWeekReach { get; set; } = 0;

        [JsonProperty("week_over_week_text")] public int? WeekOverWeekText { get; set; } = 0;
