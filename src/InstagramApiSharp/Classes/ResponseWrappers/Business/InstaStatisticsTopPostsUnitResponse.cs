...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Business
{
    public class InstaStatisticsTopPostsUnitResponse
    {
        ...
        [JsonProperty("summary_posts")] public InstaStatisticsTopPostsResponse SummaryPosts { get; set; }

        [JsonProperty("top_posts")] public InstaStatisticsTopPostsResponse TopPosts { get; set; }
