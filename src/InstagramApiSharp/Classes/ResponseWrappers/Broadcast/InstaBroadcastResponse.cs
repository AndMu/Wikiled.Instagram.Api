...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Broadcast
{
    public class InstaBroadcastResponse
    {
        ...
        [JsonProperty("dash_playback_url")] public string DashPlaybackUrl { get; set; }
        ...
        [JsonProperty("rtmp_playback_url")] public string RtmpPlaybackUrl { get; set; }

        [JsonProperty("viewer_count")] public long ViewerCount { get; set; }
    }
}
