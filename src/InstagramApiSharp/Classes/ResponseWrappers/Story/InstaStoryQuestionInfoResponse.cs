...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Story
{
    public class InstaStoryQuestionInfoResponse
    {
        ...
        [JsonProperty("question_id")] public long QuestionId { get; set; }

        [JsonProperty("question_response_count")]
        public int? QuestionResponseCount { get; set; }

        [JsonProperty("question_type")] public string QuestionType { get; set; }

        [JsonProperty("responders")] public List<InstaStoryQuestionResponderResponse> Responders { get; set; }
