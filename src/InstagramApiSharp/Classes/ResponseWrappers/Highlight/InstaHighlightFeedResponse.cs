...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Highlight
{
    public class InstaHighlightFeedResponse
    {
        ...
        [JsonProperty("can_reshare")] public object CanReshare { get; set; }

        [JsonProperty("cover_media")] public InstaHighlightCoverMediaResponse CoverMedia { get; set; }
        ...
        [JsonProperty("seen")] public object Seen { get; set; }
