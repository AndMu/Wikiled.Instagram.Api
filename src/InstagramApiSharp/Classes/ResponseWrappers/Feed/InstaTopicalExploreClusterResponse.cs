...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Feed
{
    ...
    {
        [JsonProperty("can_mute")] public bool? CanMute { get; set; }

        [JsonProperty("context")] public string Context { get; set; }

        [JsonProperty("cover_media")] public InstaMediaItemResponse CoverMedia { get; set; }

        [JsonProperty("debug_info")] public string DebugInfo { get; set; }
