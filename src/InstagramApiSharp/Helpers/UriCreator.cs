...
namespace Wikiled.Instagram.Api.Helpers
{
    internal class UriCreator
    {
        ...
        public static Uri GetAccountDetailsUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.USERS_ACCOUNT_DETAILS, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetAllowMediaCommetsUri(string mediaId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.ALLOW_MEDIA_COMMENTS, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetApprovePendingDirectRequestUri(string threadId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_DIRECT_THREAD_APPROVE, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetApprovePendingMultipleDirectRequestUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.GET_DIRECT_THREAD_APPROVE_MULTIPLE,
                    out var instaUri))
            {
        ...
        public static Uri GetBlockUserUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_BLOCK_USER, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetBusinessBrandedSearchUserUri(string query, int count)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.BUSINESS_BRANDED_USER_SEARCH, query, count),
                    out var instaUri))
            {
        ...
        public static Uri GetBusinessInstantExperienceUri(string data)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(
                        InstaApiConstants.BUSINESS_INSTANT_EXPERIENCE,
                        data,
        ...
        public static Uri GetBusinessValidateUrlUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.BUSINESS_VALIDATE_URL,
                    out var instaUri))
            {
        ...
        public static Uri GetChallengeRequireFirstUri(string apiPath, string guid, string deviceId)
        {
            ...
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.API_SUFFIX + apiPath +
        ...
        public static Uri GetCollectionsUri(string nextMaxId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.GET_LIST_COLLECTIONS,
                    out var instaUri))
            {
        ...
        public static Uri GetCollectionUri(long collectionId, string nextMaxId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_COLLECTION, collectionId),
                    out var instaUri))
            {
        ...
        public static Uri GetCreateCollectionUri()
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.CREATE_COLLECTION,
                    out var instaUri))
            {
        ...
        public static Uri GetDeclineAllPendingDirectRequestsUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.GET_DIRECT_THREAD_DECLINEALL,
                    out var instaUri))
            {
        ...
        public static Uri GetDeclineMultplePendingDirectRequestsUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.GET_DIRECT_THREAD_DECLINE_MULTIPLE,
                    out var instaUri))
            {
                throw new Exception("Cant create URI for decline all pending direct requests");
            }
        ...
        public static Uri GetDeclinePendingDirectRequestUri(string threadId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_DIRECT_THREAD_DECLINE, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetDeleteCollectionUri(long collectionId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DELETE_COLLECTION, collectionId),
                    out var instaUri))
            {
        ...
        public static Uri GetDeleteCommentUri(string mediaId, string commentId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DELETE_COMMENT, mediaId, commentId),
                    out var instaUri))
            {
        ...
        public static Uri GetDeleteDirectMessageUri(string threadId, string itemId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DIRECT_THREAD_HIDE, threadId, itemId),
                    out var instaUri))
            {
        ...
        public static Uri GetDeleteMediaUri(string mediaId, InstaMediaType mediaType)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DELETE_MEDIA, mediaId, mediaType.ToString().ToUpper()),
                    out var instaUri))
            {
        ...
        public static Uri GetDeleteMultipleCommentsUri(string mediaId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DELETE_MULTIPLE_COMMENT, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetDirectInboxThreadUri(string threadId, string NextId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_DIRECT_THREAD, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetDirectPresenceUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.DIRECT_PRESENCE,
                    out var instaUri))
            {
        ...
        public static Uri GetDisableMediaCommetsUri(string mediaId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DISABLE_MEDIA_COMMENTS, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetDiscoverChainingUri(long userId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DISCOVER_CHAINING, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetDiscoverSuggestionDetailsUri(long userId, List<long> chainedIds)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(
                        InstaApiConstants.DISCOVER_FETCH_SUGGESTION_DETAILS,
                        userId,
        ...
        public static Uri GetEditCollectionUri(long collectionId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.EDIT_COLLECTION, collectionId),
                    out var instaUri))
            {
        ...
        public static Uri GetEditMediaUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.EDIT_MEDIA, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetExploreUri(string maxId = null, string rankToken = null)
        {
            ...
            var query =
                $"is_prefetch=false&is_from_promote=true&timezone_offset={InstaApiConstants.TIMEZONE_OFFSET}&supported_capabilities_new={JsonConvert.SerializeObject(InstaApiConstants.SupportedCapabalities)}";
        ...
        public static Uri GetFollowHashtagUri(string hashtag)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.TAG_FOLLOW, hashtag),
                    out var instaUri))
            {
        ...
        public static Uri GetFollowingTagsInfoUri(long userId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(
                        InstaApiConstants.USERS_FOLLOWING_TAG_INFO,
                        userId),
                    out var instaUri))
            {
        ...
        public static Uri GetFollowUserUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_FOLLOW_USER, userId),
                    out var instaUri))
            {
                throw new Exception("Cant create URI for getting media likers");
            }
        ...
        public static Uri GetFriendshipShowManyUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.FRIENDSHIPS_SHOW_MANY,
                    out var instaUri))
            {
        ...
        public static Uri GetFullUserInfoUri(long userId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.USERS_FULL_DETAIL_INFO, userId),
                    out var instaUri))
            {
            ...
            IEnumerable<long> nextMediaIds = null)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.TAG_RANKED, hashtag.EncodeUri()),
                    out var instaUri))
            {
            ...
            IEnumerable<long> nextMediaIds = null)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.TAG_RECENT, hashtag.EncodeUri()),
                    out var instaUri))
            {
        ...
        public static Uri GetHashtagStoryUri(string hashtag)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.TAG_STORY, hashtag),
                    out var instaUri))
            {
        ...
        public static Uri GetHideDirectThreadUri(string threadId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DIRECT_THREAD_HIDE, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetHideMyStoryFromUserUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_BLOCK_FRIEND_REEL, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetHighlightsArchiveUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.ARCHIVE_REEL_DAY_SHELLS,
                    out var instaUri))
            {
        ...
        public static Uri GetLeaveThreadUri(string threadId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DIRECT_THREAD_LEAVE, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetLikeCommentUri(string commentId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LIKE_COMMENT, commentId),
                    out var instaUri))
            {
        ...
        public static Uri GetLikeMediaUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LIKE_MEDIA, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetLocationFeedUri(string locationId, string maxId = null)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LOCATION_FEED, locationId),
                    out var instaUri))
            {
        ...
        public static Uri GetLocationInfoUri(string externalId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LOCATIONS_INFO, externalId),
                    out var instaUri))
            {
        ...
        public static Uri GetLocationSearchUri()
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.LOCATION_SEARCH,
                    out var instaUri))
            {
        ...
        public static Uri GetLocationSectionUri(string locationId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LOCATION_SECTION, locationId),
                    out var instaUri))
            {
        ...
        public static Uri GetMediaCommentsMinIdUri(string mediaId, string nextMinId = "")
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_COMMENTS, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetMediaCommetLikersUri(string mediaId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_COMMENT_LIKERS, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetMediaIdFromUrlUri(Uri uri)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_MEDIAID, uri.AbsoluteUri),
                    out var instaUri))
            {
        ...
        public static Uri GetMediaInsightsUri(string unixTime)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.INSIGHTS_MEDIA, unixTime),
                    out var instaUri))
            {
        ...
        public static Uri GetMediaLikersUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_LIKERS, mediaId),
                    out var instaUri))
            {
                throw new Exception("Cant create URI for getting media likers");
            }
        ...
        public static Uri GetMediaShareUri(InstaMediaType mediaType)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DIRECT_BROADCAST_MEDIA_SHARE, mediaType.ToString().ToLower()),
                    out var instaUri))
            {
        ...
        public static Uri GetMediaSingleInsightsUri(string mediaPk)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(
                        InstaApiConstants.INSIGHTS_MEDIA_SINGLE,
                        mediaPk,
        ...
        public static Uri GetMediaUri(string mediaId)
        {
            return Uri.TryCreate(
                       BaseInstagramUri,
                       string.Format(InstaApiConstants.GET_MEDIA, mediaId),
                       out var instaUri)
                       ? instaUri
                       : null;
        }
        ...
        public static Uri GetMuteFriendStoryUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_MUTE_FRIEND_REEL, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetPostCommetUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.POST_COMMENT, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetProductInfoUri(long productId, string mediaPk, int deviceWidth)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(
                        InstaApiConstants.COMMERCE_PRODUCT_INFO,
                        productId,
                        mediaPk,
                        deviceWidth),
                    out var instaUri))
        ...
        public static Uri GetPromotableMediaFeedsUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.FEED_PROMOTABLE_MEDIA,
                    out var instaUri))
            {
        ...
        public static Uri GetReelMediaUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.FEED_REEL_MEDIA,
                    out var instaUri))
            {
        ...
        public static Uri GetRemoveFollowerUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_REMOVE_FOLLOWER, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetReportCommetUri(string mediaId, string commentId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_REPORT_COMMENT, mediaId, commentId),
                    out var instaUri))
            {
        ...
        public static Uri GetReportMediaUri(string mediaId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_REPORT, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetReportUserUri(long userId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.USERS_REPORT, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetSaveMediaUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_SAVE, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetSearchUserUri(string text, int count = 30)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(
                        InstaApiConstants.USERS_SEARCH,
        ...
        public static Uri GetSetBestFriendsUri()
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.FRIENDSHIPS_SET_BESTIES,
                    out var instaUri))
            {
        ...
        public static Uri GetSetBusinessCategoryUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.BUSINESS_SET_CATEGORY,
                    out var instaUri))
            {
        ...
        public static Uri GetShareLinkFromMediaId(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_SHARE_LINK, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetStarThreadUri(string threadId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DIRECT_STAR, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetStoryPollVotersUri(string storyMediaId, string pollId, string maxId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_STORY_POLL_VOTERS, storyMediaId, pollId),
                    out var instaUri))
            {
        ...
        public static Uri GetStoryPollVoteUri(string storyMediaId, string pollId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_STORY_POLL_VOTE, storyMediaId, pollId),
                    out var instaUri))
            {
        ...
        public static Uri GetStoryQuestionResponseUri(string storyId, long questionid)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_STORY_QUESTION_RESPONSE, storyId, questionid),
                    out var instaUri))
            {
        ...
        public static Uri GetSuggestedTagsUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.TAG_SUGGESTED,
                    out var instaUri))
            {
                throw new Exception("Cant create URI for suggested tags");
            }
        ...
        public static Uri GetSyncContactsUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.ADDRESSBOOK_LINK,
                    out var instaUri))
            {
        ...
        public static Uri GetTopSearchUri(string rankToken, string querry = "", InstaDiscoverSearchType searchType = InstaDiscoverSearchType.Users, int timezone_offset = 12600)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FBSEARCH_TOPSEARCH_FALT_PARAMETER, rankToken, timezone_offset, querry, searchType.ToString().ToLower()),
                    out var instaUri))
            {
                throw new Exception("Cant create URI for suggested search");
            }
        ...
        public static Uri GetTranslateBiographyUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LANGUAGE_TRANSLATE, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetTranslateCommentsUri(string commendIds)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.LANGUAGE_TRANSLATE_COMMENT, commendIds),
                    out var instaUri))
            {
        ...
        public static Uri GetUnBlockUserUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_UNBLOCK_USER, userId),
                    out var instaUri))
            {
                throw new Exception("Cant create URI for getting media likers");
            }
        ...
        public static Uri GetUnFollowHashtagUri(string hashtag)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.TAG_UNFOLLOW, hashtag),
                    out var instaUri))
            {
        ...
        public static Uri GetUnFollowUserUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_UNFOLLOW_USER, userId),
                    out var instaUri))
            {
                throw new Exception("Cant create URI for getting media likers");
            }
        ...
        public static Uri GetUnHideMyStoryFromUserUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_UNBLOCK_FRIEND_REEL, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetUnLikeCommentUri(string commentId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.UNLIKE_COMMENT, commentId),
                    out var instaUri))
            {
        ...
        public static Uri GetUnLikeMediaUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.UNLIKE_MEDIA, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetUnMuteFriendStoryUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.FRIENDSHIPS_UNMUTE_FRIEND_REEL, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetUnSaveMediaUri(string mediaId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_UNSAVE, mediaId),
                    out var instaUri))
            {
        ...
        public static Uri GetUnStarThreadUri(string threadId)
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.DIRECT_UNSTAR, threadId),
                    out var instaUri))
            {
        ...
        public static Uri GetUpdateBusinessInfoUri()
        {
            if (
                !Uri.TryCreate(
                    BaseInstagramUri,
                    InstaApiConstants.ACCOUNTS_UPDATE_BUSINESS_INFO,
                    out var instaUri))
            {
        ...
        public static Uri GetUserFollowersUri(long userPk, string rankToken, string searchQuery, bool mutualsfirst = false, string maxId = "")
        {
            ...
            if (!mutualsfirst)
            {
                if (!Uri.TryCreate(
                        BaseInstagramUri,
                        string.Format(InstaApiConstants.FRIENDSHIPS_USER_FOLLOWERS, userPk, rankToken),
                        out instaUri))
                {
            ...
            else
            {
                if (!Uri.TryCreate(
                        BaseInstagramUri,
                        string.Format(InstaApiConstants.FRIENDSHIPS_USER_FOLLOWERS_MUTUALFIRST, userPk, rankToken, "1"),
                        out instaUri))
                {
                    throw new Exception("Cant create URI for user followers");
                }
        ...
        public static Uri GetUserReelFeedUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.USER_REEL_FEED, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetUserStoryUri(long userId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_USER_STORY, userId),
                    out var instaUri))
            {
        ...
        public static Uri GetUserTagsUri(long userPk, string rankToken, string maxId = null)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.GET_USER_TAGS, userPk),
                    out var instaUri))
            {
        ...
        public static Uri GetVoteStorySliderUri(string storyMediaId, string pollId)
        {
            if (!Uri.TryCreate(
                    BaseInstagramUri,
                    string.Format(InstaApiConstants.MEDIA_STORY_SLIDER_VOTE, storyMediaId, pollId),
                    out var instaUri))
            {
