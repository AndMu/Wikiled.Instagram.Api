...
namespace Wikiled.Instagram.Api.API
{
    ...
    public interface IInstaApi
    {
        ...
        ///     </para>
        ///     <para>
        ///         Note 2: this is optional, if you didn't set this, <seealso cref="InstagramApiSharp" /> will choose random
        ///         device.
        ///     </para>
        /// </summary>
        ...
        ///     Login using cookies
        ///     <para>
        ///         Note: You won't be able to change password, if you use <see cref="LoginWithCookiesAsync(string)" /> function
        ///         for logging in!
        ///     </para>
        /// </summary>
