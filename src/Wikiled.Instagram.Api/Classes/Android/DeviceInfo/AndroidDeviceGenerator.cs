...
namespace Wikiled.Instagram.Api.Classes.Android.DeviceInfo
{
    public class AndroidDeviceGenerator
    {
        ...
        {
            InstaAndroidDevices.LgOptimusG,
            InstaAndroidDevices.Nexus7Gen2,
            InstaAndroidDevices.Nexus7Gen1,
            InstaAndroidDevices.Htc10,
            InstaAndroidDevices.Galaxy6,
            InstaAndroidDevices.Galaxy5,
            InstaAndroidDevices.LgOptimusF6,
            InstaAndroidDevices.Nexus5X,
            InstaAndroidDevices.Nexus5,
            InstaAndroidDevices.GalaxyS7Edge,
            InstaAndroidDevices.GalaxyS4,
            InstaAndroidDevices.Nexus6P,
            InstaAndroidDevices.GalaxyTab,
            InstaAndroidDevices.GalaxyTab3,
            InstaAndroidDevices.SamsungNote3,
            InstaAndroidDevices.Nexus4Chroma,
            InstaAndroidDevices.SonyZ3Compact,
            InstaAndroidDevices.XperiaZ5,
            InstaAndroidDevices.Honor8Lite,
            InstaAndroidDevices.XiaomiMi4W,
            InstaAndroidDevices.HtcOnePlus
        };
