...
{
    public class InstaDirectInboxItemResponse : InstaBaseStatusResponse
    {
        // end
        [JsonProperty("action_log")]
        public InstaActionLogResponse ActionLogMedia { get; set; }

        [JsonProperty("animated_media")]
        public InstaAnimatedImageResponse AnimatedMedia { get; set; }

        [JsonProperty("client_context")]
        public string ClientContext { get; set; }

        [JsonProperty("felix_share")]
        ...
        [JsonProperty("live_viewer_invite")]
        ...
        public InstaPlaceholderResponse Placeholder { get; set; }

        [JsonProperty("profile")]
        public InstaUserShortResponse ProfileMedia { get; set; }

        [JsonProperty("preview_medias")]
        public List<InstaMediaItemResponse> ProfileMediasPreview { get; set; }
        ...
        [JsonProperty("raven_media")]
        public InstaVisualMediaResponse RavenMedia { get; set; }

        [JsonProperty("reply_chain_count")]
        ...
        [JsonProperty("reel_share")]
        public InstaReelShareResponse ReelShareMedia { get; set; }

        [JsonProperty("story_share")]
        public InstaStoryShareResponse StoryShare { get; set; }
        ...
        [JsonProperty("visual_media")]
        public InstaVisualMediaContainerResponse VisualMedia { get; set; }

        [JsonProperty("voice_media")]
        public InstaVoiceMediaResponse VoiceMedia { get; set; }
    }
}