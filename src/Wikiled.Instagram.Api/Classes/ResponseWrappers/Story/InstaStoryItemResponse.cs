...
namespace Wikiled.Instagram.Api.Classes.ResponseWrappers.Story
{
    public class InstaStoryItemResponse
    {
        ...
        [JsonProperty("story_is_saved_to_archive")]
