    ...
    internal class InstaBroadcastCreateConverter : IObjectConverter<InstaBroadcastCreate, InstaBroadcastCreateResponse>
    {
        ...
        public InstaBroadcastCreate Convert()
        {
            ...
            var createBroadcast = new InstaBroadcastCreate
            {
                ...
                StreamNetworkConnectionRetryDelayInSeconds =
                    SourceObject.StreamNetworkConnectionRetryDelayInSeconds,
                StreamNetworkSpeedTestPayloadSizeInBytes = SourceObject.StreamNetworkSpeedTestPayloadSizeInBytes,
                StreamNetworkSpeedTestPayloadTimeoutInSeconds =
                    SourceObject.StreamNetworkSpeedTestPayloadTimeoutInSeconds,
                StreamNnetworkSpeedTestPayloadChunkSizeInBytes =
                    SourceObject.StreamNnetworkSpeedTestPayloadChunkSizeInBytes,
