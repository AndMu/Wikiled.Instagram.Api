...
{
    public static class InstaWebBrowserHelper
    {
            ...
            if (intPtr == IntPtr.Zero ? true : 259 != Marshal.GetLastWin32Error())
            {
                ...
                if (intPtr == IntPtr.Zero ? true : 259 != Marshal.GetLastWin32Error())
                {
                    ...
                    while (true)
                    {
                        flag = true;
                        var structure =
                            (InstaInternetCacheEntryInfoa)Marshal.PtrToStructure(
                                zero,
                                typeof(InstaInternetCacheEntryInfoa));
        ...
        public struct InstaInternetCacheEntryInfoa
        {
